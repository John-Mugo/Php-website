...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-blue w3-card">
            ...
            <div class="w3-bar-item w3-button w3-padding-large w3-hide-small" onclick="document.getElementById('Ordermodal').style.display='block'"><i class="fas fa-cart-plus"></i>ORDER</div>
            <a href="#contact" class="w3-bar-item w3-button w3-padding-large w3-hide-small"><i class="fa fa-fw fa-envelope"></i>CONTACT</a>
            <a href="#Search" class="w3-bar-item w3-button w3-right w3-padding-large w3-hide-small">Search...<i class="fa fa-search"></i></a>
    ...
    <div id="navigation" class="w3-bar-block w3-blue-gray w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
        ...
        <div class="w3-bar-item w3-button w3-padding-large" onclick="myFunction() ;document.getElementById('Ordermodal').style.display='block'"><i class="fas fa-cart-plus"></i>ORDER</div>
